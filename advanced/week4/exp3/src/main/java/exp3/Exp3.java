...
public class Exp3 {
    private static final String PATH = "./src/main/resources/admission_ticket.docx";
    ...
    public static void generateAdmissionTicket(String path) {
        ...
        try {
            ...
            setTitle(table);
            setExaminee(table);
            setExamineePhoto(table, new File(path).getParentFile().getPath() + "/tadokoro_kouji.jpg");
