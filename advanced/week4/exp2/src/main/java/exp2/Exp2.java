...
class SimpleImageProcessing {
    private static final String PATH = "./src/main/resources/tadokoro_kouji.jpg";
    public SimpleImageProcessing() {
        new SimpleImageProcessingJFrame();
    }
    private class SimpleImageProcessingJFrame extends JFrame {
        ...
        public SimpleImageProcessingJFrame() {
            try {
