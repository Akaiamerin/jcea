...
import exp1.dao.impl.UserDAOImpl;
...
public class VerifyServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        if (Objects.equals(req.getAttribute("option"), "login") == true) {
            User curUser = new UserDAOImpl().selectUserByUsernameAndPassword(user.getUsername(), user.getPassword());
            ...
            if (new UserDAOImpl().insertUser(user) > 0) {
