...
public class Exp3 {
    ...
    public static List<List<String>> dealPoker(List<String> poker) {
        ...
        List<List<String>> players = new ArrayList<>(Arrays.asList(card1, card2, card3));
        return players;
    }
    public static void outputPoker(List<String> poker, List<List<String>> players) {
        System.out.print("底牌：");
        ...
        for (int i = 0; i < players.size(); i++) {
            ...
            for (int j = 0; j < players.get(i).size(); j++) {
                System.out.print(players.get(i).get(j) + " ");
            }
            System.out.println();
        }
    }
