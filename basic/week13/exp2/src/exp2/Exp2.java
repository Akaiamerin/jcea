...
class Garage {
    ...
    public void simulate() {
        ...
        new Thread(new Thread(new carEnter(garage)), "car1").start();
        new Thread(new Thread(new carEnter(garage)), "car2").start();
        new Thread(new Thread(new carEnter(garage)), "car3").start();
        new Thread(new Thread(new carLeave(garage)), "drv").start();
    }
}
public class Exp2 {
