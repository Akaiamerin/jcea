...
class Rational {
    ...
    public Rational plus(Rational rational) throws Exception {
        ...
        Rational ret = new Rational((numerator + rational.numerator) / gcd, denominator * rational.denominator / gcd);
        return ret;
    }
    ...
    public Rational div(Rational rational) throws Exception {
        ...
        Rational ret = new Rational(numerator * rational.denominator / gcd, denominator * rational.numerator / gcd);
        return ret;
    }
}
public class Exp2 {
    public static void Calc(String str) {
        ...
        try {
            Rational rat1 = new Rational(num[0], num[1]);
            Rational rat2 = new Rational(num[2], num[3]);
            if (operCh == '+') {
                System.out.println(str + " = " + rat1.plus(rat2));
            }
            else if (operCh == '-') {
                System.out.println(str + " = " + rat1.minus(rat2));
            }
            else if (operCh == '*') {
                System.out.println(str + " = " + rat1.mul(rat2));
            }
            else if (operCh == '/') {
                System.out.println(str + " = " + rat1.div(rat2));
            }
        }
        catch (Exception exc) {
            exc.printStackTrace();
